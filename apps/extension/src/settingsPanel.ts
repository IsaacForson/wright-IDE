...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    icon: "cloud",
    fields: [
      { key: "providers.openrouter.enabled", label: "OpenRouter", kind: "toggle", desc: "Free key at openrouter.ai — 300+ models, many :free. Appears as openrouter:… in the picker" },
      ...
      { key: "providers.openrouter.models", label: "OpenRouter Models", kind: "stringlist", desc: "Model ids for the picker (free tiers change over time)" },
      { key: "providers.groq.enabled", label: "Groq", kind: "toggle", desc: "Free key at console.groq.com — very fast LPU inference" },
      ...
      { key: "providers.gemini.enabled", label: "Google Gemini", kind: "toggle", desc: "Free key at aistudio.google.com — generous free tier" },
      ...
      { key: "providers.gemini.models", label: "Gemini Models", kind: "stringlist", desc: "Model ids for the picker" },
      { key: "providers.cerebras.enabled", label: "Cerebras", kind: "toggle", desc: "Free key at cloud.cerebras.ai — among the fastest inference" },
      ...
      { key: "providers.cerebras.models", label: "Cerebras Models", kind: "stringlist", desc: "Model ids for the picker" },
      { key: "providers.huggingface.enabled", label: "Hugging Face", kind: "toggle", desc: "Token at huggingface.co/settings/tokens — Inference Providers router" },
      { key: "providers.huggingface.apiKey", label: "Hugging Face Token", kind: "password", placeholder: "hf_…", desc: "Required to use Hugging Face as primary or failover" },
      { key: "providers.huggingface.models", label: "Hugging Face Models", kind: "stringlist", desc: "Router model ids for the picker" },
      { key: "providers.github.enabled", label: "GitHub Models", kind: "toggle", desc: "Free with GitHub — github.com/marketplace/models" },
      { key: "providers.github.apiKey", label: "GitHub Token", kind: "password", placeholder: "ghp_…", desc: "PAT with models access" },
      { key: "providers.github.models", label: "GitHub Models list", kind: "stringlist", desc: "Model ids for the picker" },
      { key: "providers.mistral.enabled", label: "Mistral", kind: "toggle", desc: "Free tier at console.mistral.ai" },
      ...
      { key: "providers.mistral.models", label: "Mistral Models", kind: "stringlist", desc: "Model ids for the picker" },
