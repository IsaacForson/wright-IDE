...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    icon: "cloud",
    fields: [
      { key: "providers.openrouter.enabled", label: "OpenRouter", kind: "toggle", desc: "Free key at openrouter.ai — Qwen3-Coder + DeepSeek free variants for agent coding" },
      ...
      { key: "providers.openrouter.models", label: "OpenRouter Models", kind: "stringlist", desc: "Free coding/reasoning models for the picker (tiers change over time)" },
      ...
      { key: "providers.gemini.enabled", label: "Google Gemini", kind: "toggle", desc: "Free key at aistudio.google.com — best free reasoning loop + huge context" },
      ...
      { key: "providers.gemini.models", label: "Gemini Models", kind: "stringlist", desc: "2.5 Flash / Pro — drop older 2.0 models" },
      { key: "providers.cerebras.enabled", label: "Cerebras", kind: "toggle", desc: "Free key at cloud.cerebras.ai — Llama 3.3 70B at extreme throughput" },
